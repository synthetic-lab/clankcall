...
import { ModelCategoryResponseSpec, type ModelCategoryResponse } from "libclank";

// Fixture data chosen to exercise the clankcall preview's rendering:
// categories (one recommended), rolling-release aliases alongside permanent
// models, a fully populated model, a bare-minimum one, cache/reasoning
// fields, a deprecated model, and a long description to stretch the details
// view's word wrapping.
const response: ModelCategoryResponse = {
  categories: [
    {
      name: "Flagship",
      recommended: true,
      models: [
        {
          id: "demo/fast",
          name: "Fast (latest)",
          rollingRelease: { alias: "demo/omega-9000" },
          ...
          description: "Rolling alias that always tracks the newest flagship release.",
        },
        {
          id: "demo/omega-9000",
          name: "Omega 9000",
      ...
      models: [
        {
          id: "demo/cheap",
          name: "Cheap (latest)",
          rollingRelease: { alias: "demo/cachehound" },
...
ModelCategoryResponseSpec.assert(response);
